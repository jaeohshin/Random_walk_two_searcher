...
ltt=2.5
plot "./time-L.txt" i 0 w p pt 5 t "k_{off}=0",\
     "" i 1 w p pt 7 lt rgb "blue" t "0.5",\
      (2*x**2+x) w l lt 1 lw ltt lc rgb "red" t "L^2" ,\
      2.5*x**2*log(x) w l lt 1 lw ltt lc rgb "blue" t "L^2ln(L)"
